...
def image_to_patches(image, patch_size, image_grid=True):
    ...
    if image_grid:
        ...
        """
        patches = rearrange(image, 'B c (nph ph) (npw pw) -> B c nph ph npw pw', nph=num_patches_h, npw=num_patches_w)
        ...
        """
        patches = rearrange(image, 'B c (nph ph) (npw pw) -> B (nph npw) (c ph pw)', nph=num_patches_h, npw=num_patches_w)
